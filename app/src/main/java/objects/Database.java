    ...
    private static ArrayList<Question> questionArrayList = new ArrayList<Question>() {
        {
            ...
            add(new Question("Which of the following are not part of Scrum Ceremonies?", "Sprint Planning", "Sprint Review", "Sprint Backlog", "Daily Scrum Meeting", "Sprint Backlog"));
            ...
            add(new Question("Which of the following are not a characteristic of a Scrum Team?", "Self-Organising", "Cross-Functional", "Contains 5-9 people", "Part-time", "Part-time"));
